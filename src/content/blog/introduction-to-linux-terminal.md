...
ogImage: /public/assets/Designer.jpeg
featured: true
draft: false
tags:
  - terminal
...
Instead of painfully clicking through folders, you can just ask the computer through terminal to do exactly what to do.
...
This is your command prompt, your computer's way of saying, "I'm ready. What would you like me to do?"
...
Ok, we understood where we are but now lets find out what's in this directory (folder).
...
![terminal-documents-pwd-screenshot](@assets/images/terminal/introduction/terminal-documents-pwd-screenshot.png)

Damn, I have too much garbage in here, you might see less things or you might have a lot of garbage like me, haha!
...
# Practice Mission: Cementing Your Navigation Skills
...
In our next lesson, we'll learn how to move your existing files into this new organizational structure we've created. We'll bring order to that digital chaos, all from the command line!
